---
layout: page
title: About Sarzif Policy
permalink: /about/
lede: An independent research desk in Islamabad covering Pakistan's virtual asset framework, and a broker that connects licence applicants with the consultants who can get them approved.
description: Sarzif Policy is an independent regulatory research desk in Islamabad led by Noor Aslam, covering PVARA and matching VASP licence applicants with vetted consultants.
...
|---|---|
| [PVARA official]( https://pvara.org ) | Licensing framework, notifications, consultations |
...
We do not report from social media, unnamed sources, or other people's coverage. If we cannot point to a document, we do not publish the claim. Our full standards are on the [editorial policy page]({{ '/editorial-policy/' | relative_url }}).
...
Email is the only channel: **[{{ site.email }}](mailto:{{ site.email }})**. We answer within two business days.

We take regulatory tips, corrections to anything we have published, and licensing enquiries. Corrections get priority — see the [editorial policy]({{ '/editorial-policy/' | relative_url }}) for how we handle them.

If you are looking for a consultant, the [VASP Licensing page]({{ '/vasp-licensing/' | relative_url }}) is faster than email.
